...
The wider Bellman programme, external Downloads files and development environments
are excluded. Existing Bellman files are untouched.

The destination README adds a link to this working ground. The user approved committing and pushing this revised transfer on September 19, 2026.
