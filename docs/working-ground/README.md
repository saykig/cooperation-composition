...
experiments, evidence and limitations. The latest result distinguishes an optimized
fine discontinuity from conditions sufficient for smoothing. Sender information
and equilibrium consistency are essential assumptions. Novelty and empirical
validity remain open. The earlier large revision experiment remains unrun.
